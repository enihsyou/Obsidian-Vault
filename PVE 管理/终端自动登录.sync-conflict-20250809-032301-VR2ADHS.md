...
docker network create --ipv6 -d ipvlan --subnet=2409:8a1e:6e71:5eb0:2222::/112 --opt parent=eth0 public
...
```
- [Enable IPv6 for Docker containers on Ubuntu 18.04 | Medium](https://medium.com/@skleeschulte/how-to-enable-ipv6-for-docker-containers-on-ubuntu-18-04-c68394a219a2)