...
修改时间: 2026-02-01T22:59:24+08:00
---
...
目前没有解决，先靠把文件夹移到首位来避免启动应用，或者别使用空格/回车键唤醒电脑。


- `2025-08-04` 发现在按下 Win 键后快速点击电源按钮右侧空白处，有几率（30%）会产生类似于按下 Tab 键的键盘辅助选择的框，选中已固定部分的第一个项目。试想如果此时触发了点击功能（比如用于唤醒设备的空格键），就能达成“启动开始菜单第一个图标”的效果。但无法证明
- `2026-01-31` 有段时间没出现过这问题了，当前是 25H2 26200.7171，估计 MS 修复了
