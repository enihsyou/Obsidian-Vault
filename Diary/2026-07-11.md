...
修改时间: 2026-07-29T22:41:20+08:00
---
## LLM Gateway 选型
...
特别是遇到容器中 /etc/localtime 也自带 symlink 的，就必须不要再挂 `/usr/share/zoneinfo` [[Diary/2026-07-29#Docker 镜像中的 symlink 无法被 bind mount 覆盖]]

## Docker 容器使用自签名证书

之前把证书 [[Diary/2025-08-08#给 Docker Daemon 启用 TLS 验证]] 安装在主机上之后，容器中想用就得 `update-ca-certificate` 运行一次真麻烦，直接挂载是最简单的。
