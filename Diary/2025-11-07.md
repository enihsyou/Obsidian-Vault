...
修改时间: 2025-11-21T11:03:25+08:00
---
## 金百达内存条关闭灯光
...
然后 _ 绝对 _ 不能改 /etc/hosts 添加一行 `127.0.1.1 pve`，否则会回到 [[#节点 hostname 变更后 /etc/pve 目录清空]] 的表现。
