...
修改时间: 2026-01-27T17:36:13+08:00
---
## 安装的 `lf` 无法执行
...
sed -i 's#security.debian.org#mirrors.cernet.edu.cn/debian-security#g' /etc/apt/sources.list
```

for more updated information, see [[命令备忘#组件安装后的动作]]
