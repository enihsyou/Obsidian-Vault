...
修改时间: 2026-02-08T09:10:19+08:00
---
## WSL2 终端无法启动
...
- `2025-09-14` 尝试 [carlfriedrich/wsl-kernel-build](https://github.com/carlfriedrich/wsl-kernel-build)，当前的 `uname --kernel-release` 是 `6.6.87.2-microsoft-standard-WSL2`。真是个长历史，噢，这里说在 [linux-msft-wsl-6.6.75.1](https://github.com/microsoft/WSL2-Linux-Kernel/releases/tag/linux-msft-wsl-6.6.75.1) 已经官方修复了占用高的问题，但很明显我这还有无响应的问题。
- `2025-09-20` 基本跨天首次使用就能触发
- `2026-02-08` 许久没触发这问题了，当前 WSL 版本: 2.6.3.0 内核版本: 6.6.87.2-1 Windows: 10.0.26200.7171，不过有 [[2026-02-07#WSL2 在 Windows 唤醒后 DNS 不工作了]] 这问题
...
![isoflow 网络拓扑图](https://github.com/enihsyou/Homelab/blob/main/network/isoflow-export-2025-08-19T08_02_46.484Z.png?raw=true)
