...
修改时间: 2025-09-05T12:32:20+08:00
---
...
直接调用 MSYS2 的 rsync 会触发 [Automatic Unix ⟶ Windows Path Conversion](https://www.msys2.org/docs/filesystem-paths/#automatic-unix-windows-path-conversion)，把 `/bin/rsync` 转为 `$(cygpath -m /bin/rsync)`。
...
- [[2025-09-12#MSYS2 共用 Windows OpenSSH 的 SSH Agent]]
- [[#^daa4c1 |socat domain socket proxy for MSYS2]]
- [[2025-10-09#PowerShell 给 Batch 文件传带引号的参数]]
- [[2025-10-09#MSYS2 的 PATH 来源]] 避免输入完整路径

```powershell title="socat 转发 Windows SSH Agent"
