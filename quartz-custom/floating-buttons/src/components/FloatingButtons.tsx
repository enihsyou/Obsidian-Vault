...
function KeyboardIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20">
      <path
        fill="currentColor"
        d="M5 12.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m6.002-4.995a.752.752 0 1 0 1.505 0a.752.752 0 0 0-1.505 0m2.748-.253a.752.752 0 1 1 1.505 0a.752.752 0 0 1-1.505 0m-8.248.753a.752.752 0 1 0 0-1.505a.752.752 0 0 0 0 1.505M6.245 9.752a.752.752 0 1 1 1.505 0a.752.752 0 0 1-1.505 0m3.757.753a.752.752 0 1 0 0-1.505a.752.752 0 0 0 0 1.505m2.253-.753a.752.752 0 1 1 1.504 0a.752.752 0 0 1-1.504 0M8.503 8.005a.752.752 0 1 0 0-1.505a.752.752 0 0 0 0 1.505M2 5.5A1.5 1.5 0 0 1 3.5 4h13A1.5 1.5 0 0 1 18 5.5v8a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 2 13.5zM3.5 5a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-8a.5.5 0 0 0-.5-.5z"
      />
    </svg>
  )
}
    ...
    return (
      <div class={classNames(displayClass, "floating-buttons", `floating-${position}`)}>
        <div class="button-group">
          ...
          <IconButton action="shortcuts" title={t.shortcuts} tooltip={t.shortcutsTooltip}>
            <KeyboardIcon />
          </IconButton>
        </div>
      </div>
