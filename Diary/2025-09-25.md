...
修改时间: 2025-11-16T18:07:53+08:00
---
...
- [Macvlan network driver | Docker Docs](https://docs.docker.com/engine/network/drivers/macvlan/#:~:text=a%20macvlan%20network-,cannot%20communicate,-with%20the%20host)

相同的问题也会发生在 IPVLAN 设置中，从主机无法访问容器。此时用 Bridge 因为自带路由表所以可以。

`2025-11-16` 已经解决了，见 [[2025-11-16#给 Docker 配置完整的 IPv6 macvlan 网络环境]] 
...
`2025-11-16` 总结经验，还是 MACVLAN 适合我，见 [[2025-11-16#给 Docker 配置完整的 IPv6 macvlan 网络环境]]