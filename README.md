...
本分支是用来构建[涼果笔记](https://obsidian.kokomi.me)网站的，真正的笔记文件在[另一个分支](https://github.com/enihsyou/Obsidian-Vault)上，基于 [Quartz v4](https://quartz.jzhao.xyz/) 框架，使用 EdgeOne Pages 部署。
