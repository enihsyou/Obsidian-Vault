...
修改时间: 2025-11-20T21:17:36+08:00
---
## 金百达内存条关闭灯光
...
这里的 br0 是面向 LAN 的端口，不能是面向 WAN 的接口，而且这个 LAN 网卡上得有个 /64 地址。 ^b1b6be
如果看到接口上没有 /64 地址，可以临时用 `ip addr add 2409:xxxx: dev br0` 添加一个来验证效果。
