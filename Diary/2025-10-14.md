...
> 注意请求参数需要添加 `show_env=1`，如果不是看到 [Include X-Forwarded-For header in headers section · 议题 #300 · postmanlabs/httpbin](https://github.com/postmanlabs/httpbin/issues/300) 完全没有文档说明。