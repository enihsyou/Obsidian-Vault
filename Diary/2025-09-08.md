...
在 SSH 中使用右键，或者 <kbd>Ctrl+Shift+V</kbd> 粘贴剪切板里的文本到远程时，会丢失特定字符。

| 粘贴内容                                        | 表现结果      | 说明           |
| ------------------------------------------- | --------- | ------------ |
| `12345678901abcdef`                         | `1abcdef` | 开头的 10 位数字丢失 |
| `` a{b}c[d]e-f*g/h~i`j%k^l$m#n@o"p'q<r>s `` |           |              |
|                                             |           |              |

问题只发生在 PowerShell + `C:\Program Files\OpenSSH\ssh.exe` 上，WSL、Git-Bash、CMD 使用同样的 SSH 就没有问题。
