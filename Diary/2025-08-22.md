...
修改时间: 2025-08-22T00:02:40+08:00
---
...
评分链接：[PageSpeed Insights](https://pagespeed.web.dev/analysis/https-blog-kokomi-me-posts-emacs-shortcuts-on-macos/swx424hjcl?hl=zh_CN&form_factor=desktop)

- 网络依赖关系树部分，FontAwesome 的 woff2 字体资源下载要等到 all.min.css 下载完成后才开始，又慢又大。
  资源链接都是已知的，使用 `<link rel="preload" as="font" crossorigin>` 预取字体资源
- 进度条组件 `pace` 加载占了点时间，用处不大也去了吧
- 动画速度 200ms 改成了 120ms 显得快哈哈

### 改版 78 分

评分链接：[PageSpeed Insights](https://pagespeed.web.dev/analysis/https-blog-kokomi-me-posts-emacs-shortcuts-on-macos/nlewq3epmb?hl=zh_CN&form_factor=desktop)

- 从三方加载的 JetBrains Maple Mono 字体下载量占了整体 40%，感觉为了 CJK 等宽字符代价太大，切换成官方版 JetBrains Mono，以后代码块尽量写英语哈哈
- 显示 CSS 和 HTML 尺寸可以缩小，确实没有 minify，加个 `hexo-minify` 依赖做这事

### 改版 88 分

评分链接：[PageSpeed Insights](https://pagespeed.web.dev/analysis/https-blog-kokomi-me-posts-emacs-shortcuts-on-macos/jmtim9fquo?hl=zh_CN&form_factor=desktop)
