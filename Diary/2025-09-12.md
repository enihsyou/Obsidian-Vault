...
受 [Sharing the ssh agent between Windows and WSL | sxda.io](https://sxda.io/posts/sharing-ssh-agent-wsl/) 的启发，感觉用 systemd 提供的 socket 触发启动进程的模式更加合理。也不用安装 socat 了。
