...
修改时间: 2026-02-05T18:10:45+08:00
---
## 非线性列车 - 列车中转站只允许移动端访问
...
`2026-02-03` 并不是 Docker 吞掉了 NS 消息，而是更上层的 OpenWrt 和 PVE，见 [[2026-02-03#多接口在同一个 IPv6 网段下的冲突]]。所以那个 ping 就没必要了，最终这样：
...
`2026-02-05` 其实问题是 [[2026-02-05#PVE 下的网桥应该关闭 multicast snooping]]