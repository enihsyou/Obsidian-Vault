...
修改时间: 2025-12-08T23:17:22+08:00
---
首次打开 `regedit` ，鼠标点击地址栏的 _中间位置_ 再按下 <kbd>Ctrl+A</kbd>，并不会全选内容，只会让光标移动到末尾。再次按下 <kbd>Ctrl+A</kbd> 才会全选。

> `2025-12-08` 系统版本 25H2(26200.7171) 现在第二次按下<kbd>Ctrl+A</kbd>不再全选，而是清空地址栏
