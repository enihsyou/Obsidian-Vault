...
修改时间: 2026-01-29T17:39:20+08:00
---
...
不知怎得，断电或者死机，今天路由器重启了，以前也发生过。RT-AX86U 上的 JFFS 分区文件像是丢了一样，我编写 DNSmasq 的配置文件不翼而飞，上面记录了很多关于 IP 地址池分配的指令。现在局域网里各个设备拿到的都是随机的新的 IP 地址，无法通过设备名关联到解析记录。特别是小爱音箱等 IoT 设备，得手动断点重启才能重新取得 IP。
