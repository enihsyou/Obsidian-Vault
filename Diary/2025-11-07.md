...
修改时间: 2026-05-21T16:59:52+08:00
---
## 金百达内存条关闭灯光
...
- 允许 `183.195.48.0/20`，这是当前中国移动网络出口的 IP 所属 [AS24400](https://www.ip.network/AS24400/183.195.48.0/22) 的 CIDR，应对未来出口 IP 发生变化，可以通过访问 [ihmily/ip-info-api: Free IP information query APIs / 免费IP信息查询API接口，GET请求，可直接访问，无任何鉴权](https://github.com/ihmily/ip-info-api) 查询当前 IP，然后查询 ASAP 信息
- 允许 `2409:8a1e:6940::/43`，这是当前 IPv6 网段，用 `curl -6 ip.network` 获取再查询 AS24400 信息，选一个 [上级子网](https://www.bigdatacloud.com/network-lookup/2409:8a1e:6940::/43)
