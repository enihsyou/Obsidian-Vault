...
修改时间: 2026-02-13T20:17:12+08:00
---
...
把之前写在 [仓库的文件](https://github.com/enihsyou/dotfiles/blob/Windows/system/Windows/GANSS-GS87-AppKey-Remap.reg) 记录在这里，记得每次系统更新后重新做一遍
...
- [I can't reuse my shell in a task's commands | FAQ | Task](https://taskfile.dev/docs/faq#i-can-t-reuse-my-shell-in-a-task-s-commands)
```yml
version: "3"
tasks:
  multiline-split:
