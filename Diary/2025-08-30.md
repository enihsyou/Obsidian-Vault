...
修改时间: 2026-03-21T19:06:37+08:00
---
## 迁移 Hyper-V 到 PVE
...
$Thumbprint = (Get-ChildItem "Cert:\LocalMachine\My" | Where-Object {$_.Subject -match "CN=$CN"}).Thumbprint
...
如果第一步 Thumbprint 为空，检查是否导入到本地计算机了。如果导入证书时一路下一步，默认会在当前用户下，需要改成本地计算机
